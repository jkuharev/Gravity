 ...
 */
public class FastLinearRTW extends BandedRTW
{
	 ...
	 * @param topPeaks
	*/
	public FastLinearRTW(List<IMSPeak> leftPeaks, List<IMSPeak> topPeaks)
	{
	...
	{
		// init column ranges
		// initColRanges(); // called automatically while executing getColRanges()
		// plotColRanges();
